...
import { getAllDocumentationsNotApproved } from "../../api";
import { Pagination, GetAllError } from "../../components";
import "./GetAllDocumentation.css";

export const GetAllDocumentationsNotApproved: React.FC = () => {
    ...
    useEffect(() => {
        const getDocumentation = async () => {
            try {
                const data = await getAllDocumentationsNotApproved(page, limit);
