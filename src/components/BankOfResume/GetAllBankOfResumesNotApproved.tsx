...
import { getAllBankOfResumesNotApproved } from "../../api";
import { Pagination, GetAllError } from "../../components";
import "./GetAllBankOfResume.css";

export const GetAllBankOfResumesNotApproved: React.FC = () => {
    const [bankOfResumeList, setBankOfResumeList] = useState<BankOfResumeGetResponse[]>([]);
    ...
    useEffect(() => {
        const getBankOfResume = async () => {
            try {
                const data = await getAllBankOfResumesNotApproved(page, limit);
